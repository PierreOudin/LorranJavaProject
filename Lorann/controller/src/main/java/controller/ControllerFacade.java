 ...
 *
 * @author Dorian Buquet et Pierre OUDIN
 * @version 1.0
 */
public class ControllerFacade implements IController {
    ...
    public void start() throws SQLException {
		...
		/**
		 * Show a window for the game
		 */
		
		JFrame frmM = new JFrame();
		frmM.setTitle("Lorann");
        frmM.setSize(new Dimension(750,480));
        ...
        /**
         * Replace the characters on the BDD by sprites
         */
